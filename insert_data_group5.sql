-- ============================================
-- CPSC 332 - Project
-- File: insert_data_group5.sql
--       (rename: replace 5 with your group number)
-- Group: Group 5
...
-- ============================================
-- SECTION 3: YOUR NEW DATA/RECORDS
-- Data Source: World Bank Open Data (data.worldbank.org), Year: 2020
-- ============================================

-- Economic_Indicators - 22 rows across 6 continents
START TRANSACTION;
INSERT INTO Economic_Indicators (country_code, year, gdp_usd, gdp_per_capita, inflation_rate) VALUES
  ('ARG', 2020, 385740508436.97, 8535.60, 42.02),
  ('AUS', 2020, 1333336461648.09, 51983.45, 0.85),
  ('BRA', 2020, 1476107292151.95, 7074.19, 3.21),
  ('CAN', 2020, 1655684730000.19, 43537.84, 0.72),
  ('CHN', 2020, 14996414166715.10, 10627.46, 2.42),
  ('COL', 2020, 270348342541.46, 5339.69, 2.53),
  ('DEU', 2020, 3941398957073.94, 47394.87, 0.14),
  ('EGY', 2020, 383817841547.10, 3511.11, 5.04),
  ('FRA', 2020, 2647926055110.05, 39169.86, 0.48),
  ('GBR', 2020, 2724001478304.59, 40812.68, 0.99),
  ('IDN', 2020, 1059054842698.48, 3853.70, 1.92),
  ('IND', 2020, 2674851578587.27, 1907.04, 6.62),
  ('JPN', 2020, 5054068005376.28, 40028.73, -0.02),
  ('KEN', 2020, 100657505750.54, 1927.66, 5.41),
  ('KOR', 2020, 1744070276373.34, 33645.77, 0.54),
  ('MEX', 2020, 1121064767308.42, 8841.27, 3.40),
  ('NGA', 2020, 598586817819.07, 2797.18, 13.25),
  ('NZL', 2020, 213029554653.69, 41997.78, 1.71),
  ('SAU', 2020, 767951200000.00, 24338.83, 3.37),
  ('TUR', 2020, 733628247119.08, 8798.12, 12.28),
  ('USA', 2020, 21060473613000.00, 63515.95, 1.23),
  ('ZAF', 2020, 337974655408.05, 5580.60, 3.23);
COMMIT;

-- Trade_Statistics - 22 rows across 6 continents
START TRANSACTION;
INSERT INTO Trade_Statistics (country_code, year, exports_usd, imports_usd, trade_balance) VALUES
  ('ARG', 2020, 64053810078.31, 52454091268.19, 11599718810.12),
  ('AUS', 2020, 319174580744.37, 274154332727.11, 45020248017.26),
  ('BRA', 2020, 242872081037.20, 233941255872.60, 8930825164.60),
  ('CAN', 2020, 487990676642.93, 524572641557.22, -36581964914.29),
  ('CHN', 2020, 2729884575163.89, 2374737462777.69, 355147112386.20),
  ('COL', 2020, 36557247848.54, 55511423806.51, -18954175957.97),
  ('DEU', 2020, 1541867660412.46, 1332733837256.03, 209133823156.43),
  ('EGY', 2020, 47872738615.10, 75433562071.12, -27560823456.02),
  ('FRA', 2020, 756174143647.16, 801836174373.08, -45662030725.91),
  ('GBR', 2020, 815801724783.58, 795714534395.16, 20087190388.42),
  ('IDN', 2020, 183546577017.38, 165646843301.93, 17899733715.44),
  ('IND', 2020, 499728529072.63, 510244747372.17, -10516218299.54),
  ('JPN', 2020, 785057625362.30, 798645128766.75, -13587503404.45),
  ('KEN', 2020, 11516270712.15, 19082744156.50, -7566473444.35),
  ('KOR', 2020, 603713417774.20, 539436709934.32, 64276707839.88),
  ('MEX', 2020, 439853932827.97, 421735413258.96, 18118519569.01),
  ('NGA', 2020, NULL, NULL, NULL),
  ('NZL', 2020, 46221338362.69, 47463185028.67, -1241846665.98),
  ('SAU', 2020, 182847733333.33, 182183733333.33, 664000000.00),
  ('TUR', 2020, 210844790111.58, 232192230750.63, -21347440639.04),
  ('USA', 2020, 2151139000000.00, 2777341000000.00, -626202000000.00),
  ('ZAF', 2020, 93199600859.22, 78355182004.12, 14844418855.10);
COMMIT;

-- Labor_Force - 22 rows across 6 continents
START TRANSACTION;
INSERT INTO Labor_Force (country_code, year, labor_rate, female_rate, youth_unemp) VALUES
  ('ARG', 2020, 63.72, 46.81, 30.17),
  ('AUS', 2020, 77.76, 60.12, 14.15),
  ('BRA', 2020, 67.02, 50.25, 30.21),
  ('CAN', 2020, 77.72, 59.80, 20.11),
  ('CHN', 2020, 74.01, NULL, 14.19),
  ('COL', 2020, 68.24, 51.50, 27.02),
  ('DEU', 2020, 78.53, 55.42, 7.86),
  ('EGY', 2020, 44.02, 14.40, 17.44),
  ('FRA', 2020, 71.09, 50.63, 20.61),
  ('GBR', 2020, 77.69, 58.63, 13.62),
  ('IDN', 2020, 69.64, 53.18, 14.80),
  ('IND', 2020, 54.37, 26.17, 24.54),
  ('JPN', 2020, 79.84, 53.12, 4.68),
  ('KEN', 2020, 67.45, NULL, NULL),
  ('KOR', 2020, 67.89, 53.18, 10.26),
  ('MEX', 2020, 60.24, 41.36, 8.04),
  ('NGA', 2020, 80.10, NULL, NULL),
  ('NZL', 2020, 80.65, 65.18, 12.44),
  ('SAU', 2020, 63.82, 29.51, 29.41),
  ('TUR', 2020, 54.51, 30.89, 25.28),
  ('USA', 2020, 71.87, 56.20, 14.92),
  ('ZAF', 2020, 54.64, 44.08, 59.36);
COMMIT;